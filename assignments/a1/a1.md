...
Python and its environment. For each question write your answers in the
corresponding file: [q1.py](q1.py), [q2.py](q2.py), [q3.py](q3.py), and
[q4.py](q4.py). To get all these files at once, download
[a1_starting_files.zip](a1_starting_files.zip) extract them as to your

...
> and process the data. However, [asn_games.csv](asn_games.csv) is a plain
> text file. Depending upon your version of Mu, you may, or may not, be able
> to open a `.csv` in it. To work around this limitation, you could:
> 
> - Open [asn_games.csv](asn_games.csv) another text editor (e.g. Notepad on
>   Windows, TextEdit on a Mac).
> - Make a copy of [asn_games.csv](asn_games.csv) and rename it to
>   asn_games.py so that Mu will load it.
